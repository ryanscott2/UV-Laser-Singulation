...
Usage:
    python winlase_build_jobs.py output/DXFs/081326_AlignmentTest_v2
    python winlase_build_jobs.py output/DXFs/081326_AlignmentTest_v2 --dry-run
    python winlase_build_jobs.py <set> --verify   # build P1 in memory, report
                                                         # placement, do not save
    python winlase_build_jobs.py <setA> <setB> ... # several wafers at once
"""
