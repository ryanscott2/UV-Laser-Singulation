...
The mark speed (400 mm/s) and laser power/frequency are inherited from WinLase's
current default profile; this script prints that profile so you can confirm it, and
deliberately does not write laser parameters.
...
NUM_PASSES = 1
JOB_LOOP_COUNT = 175               # informational; set in the GUI at mark time
